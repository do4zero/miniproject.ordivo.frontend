...
.btn-outline {
  ...
  color: #20d2a6 !important;
  width: 95%;
  font-weight: 600;
}

.btn-outline:hover {
  border: 1px solid #20d2a6 !important;
}
...
.title-box {
  ...
  font-size: 15px;
  font-weight: 600;
  color: rgba($color: #20d2a6, $alpha: 1);
...
.select2-results__option[aria-selected='true'] {
  background-color: rgba(203, 255, 198, 0.3) !important;
  color: #000 !important;
  &:hover {
    color: #000 !important;
  }
